...
pub fn list(v: &impl ViewRenderer, items: &Vec<marque_oems::Model>) -> Result<Response> {
    format::render().view(v, "marque_oem/list.html", data!({"items": items}))
}
...
pub fn show(v: &impl ViewRenderer, item: &marque_oems::Model) -> Result<Response> {
    format::render().view(v, "marque_oem/show.html", data!({"item": item}))
}
...
pub fn create(v: &impl ViewRenderer) -> Result<Response> {
    format::render().view(v, "marque_oem/create.html", data!({}))
}
...
pub fn edit(v: &impl ViewRenderer, item: &marque_oems::Model) -> Result<Response> {
    format::render().view(v, "marque_oem/edit.html", data!({"item": item}))
}
